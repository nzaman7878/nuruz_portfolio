...
const Skills = () => {
  return (
    <section id="projects" className="py-32 relative bg-[#0a0a0a] overflow-hidden font-sans z-0">
...
init();`}
      ...
      <div className="container mx-auto px-5 lg:px-20 max-w-[1400px] relative z-10">
        ...
        <div className="flex flex-col items-center mb-24 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-6 -mt-16">Skills</h2>
          <p className="text-white/70 font-sans text-base max-w-lg">I am committed to lifelong learning, constantly refining my toolset to build better digital experiences.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 mb-24">
          ...
          <motion.div 
            ...
            className="glass-card rounded-[2.5rem] p-10 w-full max-w-sm flex flex-col items-center justify-center text-center group hover:-translate-y-2 transition-all duration-300"
          >
            <div className="w-20 h-20 rounded-2xl bg-[#8b5cf6]/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
              <Monitor size={36} className="text-[#8b5cf6]" />
            </div>
            <h3 className="text-2xl font-display font-bold text-white mb-4">Web Development</h3>
            <p className="text-[#06b6d4] font-mono text-xs tracking-widest font-semibold px-4 py-2 bg-[#06b6d4]/10 rounded-full">HTML, CSS, JS, REACT</p>
          </motion.div>
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0, scale: 1 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ ...springAnim, delay: 0.15 }}
            className="glass-card rounded-[2.5rem] p-10 w-full max-w-sm flex flex-col items-center justify-center text-center group hover:-translate-y-2 transition-all duration-300"
          >
            <div className="w-20 h-20 rounded-2xl bg-[#d946ef]/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
              <Smartphone size={36} className="text-[#d946ef]" />
            </div>
            <h3 className="text-2xl font-display font-bold text-white mb-4">App Development</h3>
            <p className="text-[#06b6d4] font-mono text-xs tracking-widest font-semibold px-4 py-2 bg-[#06b6d4]/10 rounded-full">IOS, ANDROID</p>
          </motion.div>

        </div>

        {/* Skill Spheres - Bento Grids */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          
          <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, margin: "-50px" }} transition={springAnim} className="glass-card rounded-[2rem] p-8 flex flex-col items-center justify-center group hover:bg-[#E44D26]/5 transition-colors">
            <div className="text-[#E44D26] mb-4 group-hover:scale-110 transition-transform duration-300">
              <HtmlIcon />
            </div>
            <span className="text-white/80 font-sans font-semibold text-lg">HTML</span>
          </motion.div>

          <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ ...springAnim, delay: 0.1 }} className="glass-card rounded-[2rem] p-8 flex flex-col items-center justify-center group hover:bg-[#264DE4]/5 transition-colors">
            <div className="text-[#264DE4] mb-4 group-hover:scale-110 transition-transform duration-300">
              <CssIcon />
            </div>
            <span className="text-white/80 font-sans font-semibold text-lg">CSS</span>
          </motion.div>

          <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ ...springAnim, delay: 0.2 }} className="glass-card rounded-[2rem] p-8 flex flex-col items-center justify-center group hover:bg-[#F7DF1E]/5 transition-colors">
            <div className="text-[#F7DF1E] mb-4 group-hover:scale-110 transition-transform duration-300">
              <JsIcon />
            </div>
            <span className="text-white/80 font-sans font-semibold text-lg">JS</span>
          </motion.div>

          <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ ...springAnim, delay: 0.3 }} className="glass-card rounded-[2rem] p-8 flex flex-col items-center justify-center group hover:bg-[#00D8FF]/5 transition-colors">
            <div className="text-[#00D8FF] mb-4 group-hover:scale-110 transition-transform duration-300">
              <ReactIcon />
            </div>
            <span className="text-white/80 font-sans font-semibold text-lg">React</span>
          </motion.div>
