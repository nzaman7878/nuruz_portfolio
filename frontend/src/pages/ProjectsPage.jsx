...
import { ChevronRight, ChevronDown, FileCode, FolderOpen, ExternalLink, Terminal } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] pt-[57px] font-mono text-[#c9d1d9] flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Sidebar / Explorer */}
        <div className="w-64 border-r border-[#30363d] bg-[#0d1117] flex-shrink-0 flex flex-col hidden md:flex">
        ...
        <div className="flex-1 flex flex-col bg-[#0d1117] overflow-hidden relative">
          ...
          {/* Tabs */}
          <div className="flex border-b border-[#30363d] bg-[#161b22] overflow-x-auto no-scrollbar">
            {openTabs.map(tab => (
              <div 
                key={tab.id}
